		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getWidgetDefAccess().getGroup_11(), "rule__WidgetDef__Group_11__0");
					...
					put(grammarAccess.getStepsLayoutDefAccess().getGroup(), "rule__StepsLayoutDef__Group__0");
					put(grammarAccess.getStepsLayoutDefAccess().getGroup_3(), "rule__StepsLayoutDef__Group_3__0");
					put(grammarAccess.getStepDefAccess().getGroup(), "rule__StepDef__Group__0");
					put(grammarAccess.getStepDefAccess().getGroup_3(), "rule__StepDef__Group_3__0");
					...
					put(grammarAccess.getWidgetDefAccess().getUsenameAssignment_3_1(), "rule__WidgetDef__UsenameAssignment_3_1");
					put(grammarAccess.getWidgetDefAccess().getAttributeNameAssignment_4_1(), "rule__WidgetDef__AttributeNameAssignment_4_1");
					put(grammarAccess.getWidgetDefAccess().getDescriptionAssignment_5_1(), "rule__WidgetDef__DescriptionAssignment_5_1");
					put(grammarAccess.getWidgetDefAccess().getXWidgetNameAssignment_6_1(), "rule__WidgetDef__XWidgetNameAssignment_6_1");
					put(grammarAccess.getWidgetDefAccess().getDefaultValueAssignment_7_1(), "rule__WidgetDef__DefaultValueAssignment_7_1");
					put(grammarAccess.getWidgetDefAccess().getHeightAssignment_8_1(), "rule__WidgetDef__HeightAssignment_8_1");
					put(grammarAccess.getWidgetDefAccess().getOptionAssignment_9_1(), "rule__WidgetDef__OptionAssignment_9_1");
					put(grammarAccess.getWidgetDefAccess().getMinConstraintAssignment_10_1(), "rule__WidgetDef__MinConstraintAssignment_10_1");
					put(grammarAccess.getWidgetDefAccess().getMaxConstraintAssignment_11_1(), "rule__WidgetDef__MaxConstraintAssignment_11_1");
					...
					put(grammarAccess.getStepsLayoutDefAccess().getNameAssignment_1(), "rule__StepsLayoutDef__NameAssignment_1");
					put(grammarAccess.getStepsLayoutDefAccess().getDescriptionAssignment_3_1(), "rule__StepsLayoutDef__DescriptionAssignment_3_1");
					put(grammarAccess.getStepsLayoutDefAccess().getStepsAssignment_4(), "rule__StepsLayoutDef__StepsAssignment_4");
					put(grammarAccess.getStepDefAccess().getNameAssignment_1(), "rule__StepDef__NameAssignment_1");
					put(grammarAccess.getStepDefAccess().getDescriptionAssignment_3_1(), "rule__StepDef__DescriptionAssignment_3_1");
					put(grammarAccess.getStepDefAccess().getLayoutItemsAssignment_4(), "rule__StepDef__LayoutItemsAssignment_4");
