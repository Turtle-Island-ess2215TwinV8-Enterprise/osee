 ...
 */
public class MockWorkStateImpl implements WorkState {
   ...
   public MockWorkStateImpl(String name, List<? extends IAtsUser> assignees) {
      this(name, assignees, 0, 0);
   }

   public MockWorkStateImpl(String name, List<? extends IAtsUser> assignees, double hoursSpent, int percentComplete) {
      this.name = name;
   ...
   public MockWorkStateImpl(String name) {
      this.name = name;
   }
