...
public class OrderParser {
   ...
   public OrderParser(RelationTypeCache relationCache) {
      ...
      switch (eventType) {
         case XMLStreamConstants.START_ELEMENT:
            ...
            if (START_TAG.equals(localName)) {
               String relationTypeName = reader.getAttributeValue(uri, RELATION_TYPE_TAG);
               ...
               if (relationTypeName != null && orderType != null && relationSide != null) {
                  ...
                  IRelationTypeSide typeSide =
                     TokenFactory.createRelationTypeSide(side, relationType.getGuid(), relationType.getName());
