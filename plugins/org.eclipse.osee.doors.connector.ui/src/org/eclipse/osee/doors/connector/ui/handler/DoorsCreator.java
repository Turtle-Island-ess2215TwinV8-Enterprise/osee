    ...
    try {
      ...
      if (parentArtifact == null) {
        ...
        Artifact rootArtifact =
            ArtifactQuery
                .checkArtifactFromTypeAndName(CoreArtifactTypes.RootArtifact, "Default Hierarchy Root", branch);
        if (rootArtifact != null) {
          parentArtifact =
              rootArtifact.addNewChild(RelationOrderBaseTypes.PREEXISTING, CoreArtifactTypes.Folder,
                  "Door Requirements");
        }
      }
      ...
      if (parentArtifact != null) {
        ...
        if (artifact == null) {
          newArtifact =
              parentArtifact.addNewChild(RelationOrderBaseTypes.PREEXISTING,
          ...
          newArtifact.setSoleAttributeFromString(TokenFactory.createAttributeType(0x0000000000002006, "Door Req URL"),
              url);
          ...
          artifact.setSoleAttributeFromString(TokenFactory.createAttributeType(0x5000000000002003L, "Door Req Name"),
              reqName);
          artifact
              .setSoleAttributeFromString(TokenFactory.createAttributeType(0x0000000000002006, "Door Req URL"), url);
      ...
      // this.nodeDisplayNamesnotAdded.add(this.name);
