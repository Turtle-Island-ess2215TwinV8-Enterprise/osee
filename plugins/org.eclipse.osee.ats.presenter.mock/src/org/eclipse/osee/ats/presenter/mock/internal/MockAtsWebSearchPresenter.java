...
public class MockAtsWebSearchPresenter { //<T extends AtsSearchHeaderComponent, K extends AtsSearchParameters> extends MockSearchPresenter<T, K> implements AtsSearchPresenter<T, K> {
   ...
   //
   //         if (options.isVerboseResults() != null) {
   //            parameters.put(UrlParamNameConstants.PARAMNAME_SHOWVERBOSE, options.isVerboseResults() ? "true" : "false");
   //         }
   //
   ...
   //                        SearchResult searchResultComp = searchResultsComp.createSearchResult();
