 ...
 */
public class CreatePortingWorkflows extends AbstractBlam {
   ...
   public String getDescriptionUsage() {
      return "Create porting workflows ralated by port relation for selected actionabe item (or same as source workflow)";
   }
