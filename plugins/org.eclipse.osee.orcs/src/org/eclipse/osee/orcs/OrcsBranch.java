...
public interface OrcsBranch {
   ...
   Callable<ReadableBranch> createPortBranch(IOseeBranch branch, ArtifactReadable author, int fromTransaction, ArtifactReadable associatedArtifact) throws OseeCoreException;
