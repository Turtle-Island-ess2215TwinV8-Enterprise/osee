...
public class OrderParserTest {
   ...
   public void setUp() throws OseeCoreException {
      ...
      when(relationTypeCache.getUniqueByName(REL_TYPE_1_NAME)).thenReturn(relationType1);
      when(relationTypeCache.getUniqueByName(REL_TYPE_2_NAME)).thenReturn(relationType2);
   }
