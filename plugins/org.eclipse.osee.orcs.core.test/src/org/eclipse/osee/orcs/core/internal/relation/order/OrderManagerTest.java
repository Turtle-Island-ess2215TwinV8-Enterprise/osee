...
public class OrderManagerTest {
   ...
   @Mock private RelationType relationType1;
   @Mock private RelationType relationType2;
   @Mock private RelationType relationType3;
   ...
   public void setUp() throws OseeCoreException {
      ...
      when(relationType1.getDefaultOrderTypeGuid()).thenReturn(RelationOrderBaseTypes.USER_DEFINED.getGuid());
      when(relationType2.getDefaultOrderTypeGuid()).thenReturn(RelationOrderBaseTypes.UNORDERED.getGuid());
      when(relationType3.getDefaultOrderTypeGuid()).thenReturn(RelationOrderBaseTypes.LEXICOGRAPHICAL_ASC.getGuid());

      when(relationType1.getGuid()).thenReturn(11L);
      when(relationType2.getGuid()).thenReturn(22L);
      when(relationType3.getGuid()).thenReturn(33L);
      ...
      when(relationTypeCache.getByGuid(11L)).thenReturn(relationType1);
      when(relationTypeCache.getByGuid(22L)).thenReturn(relationType2);
      when(relationTypeCache.getByGuid(33L)).thenReturn(relationType3);
   }
   ...
   public void testGetSorterId() throws OseeCoreException {
      ...
      verify(relationType1, times(0)).getDefaultOrderTypeGuid();

      assertEquals(RelationOrderBaseTypes.LEXICOGRAPHICAL_ASC, orderManager.getSorterId(typeSide2));
      verify(relationType2, times(0)).getDefaultOrderTypeGuid();
      ...
      verify(relationType3).getDefaultOrderTypeGuid();
   }
