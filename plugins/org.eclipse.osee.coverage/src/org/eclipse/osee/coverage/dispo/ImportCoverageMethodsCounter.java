...
public class ImportCoverageMethodsCounter {
   ...
   public String toString() {
      return String.format("Num Items %s; Num Dispo %s; Num Match %s; Num NoMatch %s; Num Files Errored %s", numItems,
         numDispo, numMatch, numNoMatch, fileToErrorCount.getCounts().size());
   }
}
